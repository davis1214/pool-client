...
public class RedisSentinelConnPool implements ConnectionPool<Jedis> {
    ...
    public RedisSentinelConnPool(final String masterName, final Set<String> sentinels) {
        ...
        this(new ConnectionPoolConfig(), masterName, sentinels);
    }
     ...
     * @param sentinels  the sentinels
     */
    public RedisSentinelConnPool(final ConnectionPoolConfig poolConfig,
     ...
     * @param properties the properties
     */
    public RedisSentinelConnPool(final ConnectionPoolConfig poolConfig, final Properties properties) {
