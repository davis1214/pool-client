...
public class JdbcConnectionPool extends ConnectionPoolBase<Connection> implements ConnectionPool<Connection> {
    ...
    public JdbcConnectionPool(final String driverClass, final String jdbcUrl, final String username, final String password) {
        ...
        this(new ConnectionPoolConfig(), driverClass, jdbcUrl, username, password);
    }
     ...
     * @param properties JDBC参数
     */
    public JdbcConnectionPool(final ConnectionPoolConfig poolConfig, final Properties properties) {
     ...
     * @param password    数据密码
     */
    public JdbcConnectionPool(final ConnectionPoolConfig poolConfig, final String driverClass, final String jdbcUrl, final String username, final String password) {
