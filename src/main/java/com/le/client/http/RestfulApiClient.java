...
import com.le.client.opentsdb.request.Pair;
 ...
 * 
 * @param T
 *            : type of the returning response object. Note: the idea of this
...
public abstract class RestfulApiClient<T> {
	 ...
	 * @param headerEntries
	 *            extra entries to be added to request header.
	 ...
	 *            host port.
	 * @param path
	 *            extra path after host.
	 * @param isHttp
	 *            indicates if whether Http or HTTPS should be used.
	 * @param params
