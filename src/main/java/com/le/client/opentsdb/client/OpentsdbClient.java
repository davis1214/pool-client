...
import com.le.client.opentsdb.request.SubQueries;
...
public class OpentsdbClient {
	...
	/*
     * public OpentsdbClient(String opentsdbUrl) { this.httpClient = new
	 * HttpClientImpl(ConfigLoader.getProperty("opentsdb.url")); }
	 */
