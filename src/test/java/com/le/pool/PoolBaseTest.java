...
//
//        ConnPool pool = new ConnPool(new ConnectionPoolConfig(), new ConnFactory());
//
//        pool.initPool(new ConnectionPoolConfig(), new ConnFactory());
//
//        pool.addObjects(1);
//
...
//
//
//        ConnPool2 pool2 = new ConnPool2(new ConnectionPoolConfig(), new ConnFactory());
//
//        try {
...
//    }
//
//    private static class ConnPool extends ConnectionPoolBase<Conn> {
//
//        private static final long serialVersionUID = 1L;
//
//        public ConnPool() {
//        }
//
//        public ConnPool(final ConnectionPoolConfig poolConfig, ConnFactory factory) {
//
//            super(poolConfig, factory);
//        }
//    }
//
//    private static class ConnPool2 extends ConnectionPoolBase<Conn> {
//
//        private static final long serialVersionUID = 1L;
//
//        public ConnPool2(final ConnectionPoolConfig poolConfig, ConnFactory factory) {
//
//            super(poolConfig, factory);
//        }
//
