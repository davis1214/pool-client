...
public class RedisShardedConnPoolTest {
    ...
    public void test() throws Exception {
        ...
        RedisShardedConnPool pool1 = new RedisShardedConnPool(new ConnectionPoolConfig(),
        ...
        RedisShardedConnPool pool = new RedisShardedConnPool(new ConnectionPoolConfig(),
